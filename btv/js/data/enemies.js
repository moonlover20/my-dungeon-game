const ENEMY_TYPES={
  ...
  // === 3막 전용 몬스터 ===
  act3_domin     :{name:"\uB3C4\uBBFC", r:23, hp:86,  spd:88, dmg:18, touchDmg:18, color:"#7ad7ff", xp:160, ai:"submerge_charge", range:420, cool:3.2, label:"\uB3C4\uBBFC"},
  act3_mirror    :{name:"오픈더", r:24, hp:112, spd:46, dmg:14,  touchDmg:14,  color:"#8be8ff", xp:175, ai:"reflector", range:360, cool:3.8, label:"오픈더"},
  act3_magnet    :{name:"소실아", r:23, hp:116, spd:42, dmg:11,  touchDmg:13,  color:"#ff4d5a", xp:165, ai:"magnet", range:220, cool:2.3, label:"소실아"},
  act3_buffering :{name:"바나나", r:22, hp:84,  spd:72, dmg:12, touchDmg:14,  color:"#38e8ff", xp:160, ai:"blink_lagfield", range:330, cool:2.8, label:"바나나"},
  act3_alppano   :{name:"\uC54C\uBE60\uB178", r:27, hp:190, spd:24, dmg:13,  touchDmg:12,  color:"#ffd34d", xp:620, ai:"summoner", range:340, cool:3.8, label:"\uC54C\uBE60\uB178"},
  act3_kullje    :{name:"\uCFFC\uC81C", r:26, hp:165, spd:92, dmg:21, touchDmg:18, color:"#ff4dd2", xp:680, ai:"stealth_assassin", range:360, cool:6.0, label:"\uCFFC\uC81C"},
  act3_clone     :{name:"타포", r:25, hp:165, spd:62, dmg:18, touchDmg:16, color:"#b86bff", xp:650, ai:"splitter", range:320, cool:1.05, label:"타포"},
  act3_truck     :{name:"노잭", r:40, hp:360, spd:24, dmg:16, touchDmg:13, color:"#58d8ff", xp:1500, ai:"beam_sweep", range:620, cool:5.8, armor:0.18, label:"노잭"},
