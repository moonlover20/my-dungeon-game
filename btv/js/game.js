...
function playerMoveSpeed(p){
  p=p||player;
  const base=Number(p&&p.spd)||BASE_PLAYER_MOVE_SPEED;
...
const RELICS=[
  // ===== 축복: 화력 =====
  {id:"coupon",name:"사장님이 미쳤어요 쿠폰",icon:"🏷️",desc:"공격력 +20%.",cls:"boon",apply:p=>{p.dmgAdd+=0.20;}},
  {id:"sniper",name:"저격수의 집중",icon:"🎯",desc:"공격력 +22%, 발사 속도 -12%.",cls:"boon",apply:p=>{p.dmgAdd+=0.22;p.fireAdd-=0.12;}},
  {id:"heavy_cal",name:"대구경 탄두",icon:"🧱",desc:"공격력 +18%, 탄 크기 +25%, 탄속 -10%.",cls:"boon",apply:p=>{p.dmgAdd+=0.18;p.bulletSize+=0.25;p.bulletSpeedMul-=0.10;}},
  {id:"bignuke",name:"분노의 대왕탄",icon:"💥",desc:"탄 크기·공격력 +20%, 발사 속도 -10%.",cls:"boon",apply:p=>{p.bulletSize+=0.20;p.dmgAdd+=0.20;p.fireAdd-=0.10;}},
  ...
  {id:"speed_bullet",name:"가속 탄두",icon:"⚡",desc:"투사체 속도 +50%, 공격력 +10%.",cls:"boon",apply:p=>{p.bulletSpeedMul+=0.50;p.dmgAdd+=0.10;}},
  {id:"fork",name:"세 갈래 포크",icon:"🍴",desc:"투사체 +1발, 공격력 +20%.",cls:"boon",apply:p=>{p.shots+=1;p.dmgAdd+=0.20;}},
  {id:"harpoon",name:"사두 작살",icon:"🔱",desc:"투사체 +2발, 공격력 +10%.",cls:"boon",apply:p=>{p.shots+=2;p.dmgAdd+=0.10;}},
  {id:"back_gun",name:"백발백중 등총",icon:"🔙",desc:"뒤로도 한 발 발사, 공격력 +10%.",cls:"boon",apply:p=>{p.backShot=true;p.dmgAdd+=0.10;}},
  ...
  {id:"long_skewer",name:"긴 꼬치",icon:"🍡",desc:"관통 +3.",cls:"boon",apply:p=>{p.pierce+=3;}},
  // ===== 축복: 군중제어/폭발 =====
  ...
  {id:"iron_skin",name:"강철 피부",icon:"🪨",desc:"받는 피해 -25%.",cls:"boon",apply:p=>{p.armor+=0.25;}},
  ...
  {id:"kijo_mask",name:"키죠의 가면",icon:"🎭",desc:"보스 피해 +35%.",cls:"boon",apply:p=>{p.bossDmgMul+=0.35;}},
  ...
  {id:"abstinence_chalice",name:"금욕의 성배",icon:"🏆",desc:"포션 0개 보유 시 공격력 +50%.",cls:"boon",apply:p=>{p.noPotionDmgMul+=0.50;}},
  ...
  {id:"seungwoo_broken_monitor",name:"승우의 깨진 모니터",icon:"📺",desc:"공격력 +30%, 치명타 확률 +20%.",cls:"boon",apply:p=>{p.dmgAdd+=0.30;p.critChance+=0.20;}},
  {id:"moving_afterimage",name:"무빙의 잔상",icon:"💨",desc:"이동속도 +25%, 회피 쿨타임 -20%.",cls:"boon",apply:p=>{p.moveSpeedAdd+=0.25;p.dodgeCdMul-=0.20;}},
  {id:"clutch_heart",name:"딸피의 심장",icon:"🫀",desc:"체력 30% 이하일 때 공격력 +28%.",cls:"boon",apply:p=>{p.lowHpMul+=0.28;}},
  ...
  {id:"collector_showcase",name:"수집가의 진열장",icon:"🗃️",desc:"공격력 +30%, 골드 획득량 +40%.",cls:"boon",apply:p=>{p.dmgAdd+=0.30;p.goldMul+=0.40;}},
  {id:"mythic_vault",name:"신화 보관함",icon:"🧰",desc:"치명타 확률 +30%, 치명타 피해 +40%.",cls:"boon",apply:p=>{p.critChance+=0.30;p.critMult+=0.40;}},
  {id:"curse_crown",name:"저주의 왕관",icon:"👑",desc:"공격력 +70%. 받는 피해 +30%.",cls:"curse",apply:p=>{p.dmgAdd+=0.70;p.damageTakenMul+=0.30;}},
  {id:"direction_compass",name:"방향성 나침반",icon:"🧭",desc:"경험치 획득량 +50%, 이동속도 +10%.",cls:"boon",apply:p=>{p.xpMul+=0.50;p.moveSpeedAdd+=0.10;}},
  ...
  {id:"hardcore_transmitter",name:"하드코어 송출기",icon:"📡",desc:"보스 피해 +30%, 공격력 +15%.",cls:"boon",apply:p=>{p.bossDmgMul+=0.30;p.dmgAdd+=0.15;}},
  {id:"nohit_wings",name:"무피격의 날개",icon:"🪽",desc:"이동속도 +40%, 회피 쿨타임 -20%.",cls:"boon",apply:p=>{p.moveSpeedAdd+=0.40;p.dodgeCdMul-=0.20;}},
  {id:"bizarre_mask",name:"기괴한 가면",icon:"🎭",desc:"공격력 +50%, 관통 +1.",cls:"boon",apply:p=>{p.dmgAdd+=0.50;p.pierce+=1;}},
  {id:"void_heart",name:"공허의 심장",icon:"🌑",desc:"공격력 +50%, 치명타 확률 +20%.",cls:"boon",apply:p=>{p.dmgAdd+=0.50;p.critChance+=0.20;}},
  {id:"guardian_shield",name:"수호자의 방패",icon:"🛡️",desc:"받는 피해 -20%.",cls:"boon",apply:p=>{p.armor+=0.20;}},
  ...
  // ===== 저주: 양날의 검 =====
  {id:"glass",name:"유리 대포",icon:"🔮",desc:"공격력 +70%. 최대 체력 -40%.",cls:"curse",apply:p=>{p.dmgAdd+=0.70;p.maxhp=Math.round(p.maxhp*0.6);p.hp=Math.min(p.hp,p.maxhp);}},
  {id:"berserk",name:"광전사의 분노",icon:"🩸",desc:"공격력 +35%. 받는 피해 +20%.",cls:"curse",apply:p=>{p.dmgAdd+=0.35;p.armor-=0.2;}},
  {id:"heavy_ammo",name:"무거운 탄약",icon:"🏋️",desc:"공격력 +30%. 이동 속도 -20%.",cls:"curse",apply:p=>{p.dmgAdd+=0.30;p.moveSpeedAdd-=0.20;}},
  ...
  {id:"one_shot",name:"모 아니면 도",icon:"💀",desc:"공격력 +80%. 최대 체력 100 고정.",cls:"curse",apply:p=>{p.dmgAdd+=0.80;setFixedMaxHp(p,100);}},
  ...
  {id:"turtle",name:"거북이 등딱지",icon:"🐢",desc:"받는 피해 -15%. 이동 속도 -15%.",cls:"curse",apply:p=>{p.armor+=0.15;p.moveSpeedAdd-=0.15;}},
  {id:"all_in",name:"올인",icon:"🎰",desc:"공격력 +40%. 받는 피해 +20%.",cls:"curse",apply:p=>{p.dmgAdd+=0.40;p.damageTakenMul+=0.20;}},
  {id:"gamble",name:"도박꾼의 주사위",icon:"🎲",desc:"매 발사 공격력 0.6~1.8배 도박.",cls:"curse",apply:p=>{p.gamble=true;}},
  {id:"cursed_mask",name:"저주받은 가면",icon:"👺",desc:"공격력 +20%, 발사속도 +10%, 이동속도 +10%, 초당 체력 -0.6.",cls:"curse",apply:p=>{p.dmgAdd+=0.20;p.fireAdd+=0.10;p.moveSpeedAdd+=0.10;p.regen-=0.6;}},
  {id:"demon_contract",name:"악마의 계약",icon:"👹",desc:"공격력 +50%. 받는 피해 +30%.",cls:"curse",apply:p=>{p.dmgAdd+=0.50;p.armor-=0.3;}},
...
const _COMMON=['bread','back_gun','potion_belt','vampire','gold_pig','xp_book'];
const _RARE=['adrenaline','roll_master','sneaker','glass_legs','turtle','slippery','speed_bullet','old_boots','strange_mushroom','hunters_eye','med_kit','blood_thirst'];
const _EPIC=['coupon','sniper','heavy_cal','bignuke','crit_glasses','clover','iron_skin','vampire_fang','nature_bless','super_bouncy','berserk','heavy_ammo','hair_trigger','recoil','thin_glass','time_bomb','gamble','cursed_mask','giant_slayer','greed','hyechul_egg','moving_afterimage','clutch_heart','direction_compass','whale_card','no_spend_wallet'];
const _LEGEND=['fork','redbull','long_skewer','stun_bell','all_in','kijo_mask','viewer_slayer_mic','abstinence_chalice','yanggaeng_black_thread','seungwoo_broken_monitor','clip_dodge_instinct','collector_showcase','hardcore_transmitter','nohit_wings','guardian_shield','greed_ring','time_warp','demon_contract','death_oath'];
const _MYTHIC=['harpoon','homing_eye','one_shot','glass','mythic_vault','curse_crown','bizarre_mask','void_heart','crit_hammer'];
const TIER_OF={};
...
const TRAINING_DEFS=[
  {id:'hp',name:'체력 훈련',icon:'❤️',desc:'최대 체력 +15, 즉시 체력 +15 회복. 이번 런 동안 영구 유지.',baseCost:155,bonusText:c=>'+'+(c*15)},
  {id:'atk',name:'공격 훈련',icon:'⚔️',desc:'공격력 +3%. 이번 런 동안 영구 유지.',baseCost:220,bonusText:c=>'+'+Math.round(c*3)+'%'},
  {id:'speed',name:'민첩 훈련',icon:'🥾',desc:'이동속도 +4%. 이번 런 동안 영구 유지.',baseCost:180,bonusText:c=>'+'+Math.round(c*4)+'%'},
...
function trainingPreviewRows(def,p){
  ...
  const rows=[];
  if(id==='hp'){
    rows.push(['최대 체력', Math.round(Number(p.maxhp)||0)+' → '+Math.round((Number(p.maxhp)||0)+15)]);
    rows.push(['즉시 회복', '+15']);
  }else if(id==='atk'){
    const cur=Number(p.trainingAtkBonus)||0;
    rows.push(['공격 훈련 보너스', trainingPct(cur)+' → '+trainingPct(cur+0.03)]);
    rows.push(['공격력', '+3%']);
  }else if(id==='speed'){
    const cur=Number(p.trainingSpeedBonus)||0;
    rows.push(['이동속도 보너스', trainingPct(cur)+' → '+trainingPct(cur+0.04)]);
    rows.push(['이동속도', '+4%']);
  }else if(id==='focus'){
    const cur=clamp(Number(p.critChance)||0,0,CRIT_CHANCE_CAP);
    const next=clamp(cur+0.03,0,CRIT_CHANCE_CAP);
    rows.push(['치명타 확률', trainingPct(cur)+' → '+trainingPct(next)]);
    rows.push(['집중 훈련 보너스', trainingPct(Number(p.trainingFocusBonus)||0)+' → '+trainingPct((Number(p.trainingFocusBonus)||0)+0.03)]);
  }else if(id==='defense'){
    const cur=Number(p.trainingDefenseBonus)||0;
    rows.push(['받는 피해 감소', trainingPct(cur)+' → '+trainingPct(cur+0.03)]);
    rows.push(['피해 감소', '+3%']);
  }
  return rows;
}
...
function applyShopTraining(id){
  const def=trainingDefById(id);
  if(currentShopItems&&currentShopItems.trainingBought) return false;
  if(!def || trainingIsMaxed(id,player)) return false;
  const tr=ensureTrainingState(player);
  if(id==='hp'){
    player.maxhp+=15;
    healPlayer(15,player.x,player.y);
    player.hp=Math.min(player.hp,player.maxhp);
  }else if(id==='atk'){
    player.trainingAtkBonus=(Number(player.trainingAtkBonus)||0)+0.03;
  }else if(id==='speed'){
    player.trainingSpeedBonus=(Number(player.trainingSpeedBonus)||0)+0.04;
  }else if(id==='focus'){
    player.trainingFocusBonus=(Number(player.trainingFocusBonus)||0)+0.03;
    player.critChance=Math.min(CRIT_CHANCE_CAP,(Number(player.critChance)||0)+0.03);
  }else if(id==='defense'){
    player.trainingDefenseBonus=(Number(player.trainingDefenseBonus)||0)+0.03;
    player.armor=Math.min(0.85,(Number(player.armor)||0)+0.03);
  }
...
function getSpecialEffectTooltipData(effectKey){
  ...
  const simpleSpecialMap={
    ...
    'poison':{title:'독침',value:()=> '+'+Math.round(Number(player.poison)||0),description:'명중 시 4초간 독을 부여합니다.',formulaText:'적용 방식: 최대 6스택, 찍을 때마다 스택당 독 피해 +3, 현재 스택당 '+Math.round(Number(player.poison)||0)},
    ...
    'status-dot-damage':{title:'상태이상 피해',value:()=>pct(Number(player.statusDotDmgMul)||0),description:'화상/독 피해가 증가합니다.',formulaText:'적용 방식: 화상 및 독의 초당 피해에 배율 적용',kind:'attack'},
...
function healPlayer(amount,x,y){
  const n=Math.max(0,Math.round(amount*statMulFromBonus(statBonusFromMul(player&&player.recoveryMul),0)));
  if(n<=0) return 0;
...
function sanitizeStoredLevelPerkIds(ids){
  return Array.isArray(ids)?ids.filter(id=>id && !!perkByStoredId(id)):[];
}
...
function resetPlayer(){
  Object.assign(player,{
    ...
    // === 신규 퍼 스탯 ===
    goldPower:0, statusDmgMul:0, statusDotDmgMul:0, critHeal:0, chainLightning:0,
...
function spawnEnemy(type,x,y,diff){
  ...
  enemies.push({
    ...
    hp:d.hp*diff*diffSet.hp,maxhp:d.hp*diff*diffSet.hp,spd:d.spd*diffSet.spd,dmg:d.dmg*dmgScale,
...
function playerShoot(){
  ...
  if(player.goldPower>0) base*=(1+Math.min(player.goldPower*Math.floor(gold/100),0.30));
...
function hurtPlayer(dmg, src){
  ...
  dmg=dmg*(1-effectiveArmor(player))*diffSet.dmg*statMulFromBonus(statBonusFromMul(player.damageTakenMul),0);
...
function updateBossStatuses(b,dt){
  ...
  if((b.psT=(b.psT||0))>0){
    b.psT-=dt;
    const poisonDps=(b.psStacks||0)*(b.psDmg||0)*statusDotDamageMul();
    b.hp-=poisonDps*dt;
    b.hitT=Math.max(b.hitT||0,0.04);
...
function damageBoss(b,dmg,crit,fromBullet,bullet){
  ...
  const dealt=dmg*statMulFromBonus(statBonusFromMul(player.bossDmgMul),0.1)*(1-(b.armor||0));
...
function killEnemy(e){
  ...
  if(!isSummon && player.corrosiveSpread && !player.statusSpread && !e._corrosiveSpreaded){
    const hadBurn=e.burnT>0, hadPois=e.psT>0;
    if(hadBurn||hadPois){
      enemies.forEach(o=>{ if(o!==e && dist2(o.x,o.y,e.x,e.y)<14400){
        if(hadBurn){ o.burnT=Math.max(o.burnT||0,2.5); o.burnDmg=Math.max(o.burnDmg||0,Math.max(1,(e.burnDmg||player.burn||4)*0.35)); }
        if(hadPois){ o.psStacks=Math.max(o.psStacks||0,1); o.psT=Math.max(o.psT||0,3); o.psDmg=Math.max(o.psDmg||0,Math.max(1,(e.psDmg||player.poison||3)*0.35)); }
        o._corrosiveSpreaded=true;
      }});
      burst(e.x,e.y,'#5dff9b',10,160);
    }
  }
...
function updateBossIntentPatterns(b,dt){
  ...
  if(b.key==='kijo'){
    ...
    else if(cd('_deleteCd',7.5)) beginSeungwooDeleteCommand(b);
  }else if(b.key==='bear'){
...
function killBoss(){
  ...
  addGold(irand(105,170),'roomReward'); sfx.coin(); burst(boss.x,boss.y,'#ffd34d',20,260);
...
function gp_totalCollapse(b){ GL.blackout=Math.max(GL.blackout||0,0.45); gView.rotT+=rand(-0.45,0.45); gView.fxT=Math.random()<0.5?-1:1; GL.rotActive=4.2; gHoming(b); gRing(b,b.enraged?18:14,170,9); banner('TOTAL COLLAPSE','방송이 찢어진다',950); }
function beginSeungwooDeleteCommand(b){
  ...
  if(ok) seungwooLaserWarns.push(beam);
  return ok;
}
...
function update(dt){
  ...
  if(!enemyFrozen) for(const e of enemies){
    ...
    if((e.psT=(e.psT||0))>0){ e.psT-=dt; const poisonDps=(e.psStacks||0)*(e.psDmg||0)*statusDotDamageMul(); const pdmg=poisonDps*dt; e.hp-=pdmg; e.hitT=Math.max(e.hitT,0.04); e._psPopT=(e._psPopT||0)-dt; if(e._psPopT<=0){ e._psPopT=0.35; if(GS.dmgNum&&typeof spawnDmgNum==='function') spawnDmgNum(e.x,e.y-e.r-4,Math.max(1,Math.round(poisonDps*0.35)),false,'poison'); } if(e.hp<=0){ handleEnemyDefeat(e); continue; } } else { e.psStacks=0; e._psPopT=0; }
    const a=Math.atan2(player.y-e.y,player.x-e.x);
    ...
    if((e.stunT=(e.stunT||0))>0){ e.stunT-=dt; }
      ...
      if(e.cs==='approach'){
        ...
        if(dist<=4||e.csT<=0){
          ...
          intentShockwave(e.x,e.y,120,18,'포베어 점프 강타');
    ...
    e.x=clamp(e.x,e.r,W-e.r); e.y=clamp(e.y,e.r,H-e.r);
    // 접촉 데미지
    if(enemyTouchBaseDamage(e)>0 && dist2(e.x,e.y,player.x,player.y)<(e.r+player.r)**2){
...
function onCombatCleared(){
  ...
  setTimeout(()=>{
    ...
    if(t==='midboss'){ const bonus=irand(70,105); addGold(bonus,'roomReward'); updateHUD(); offerRelics(3,'중간보스 보상',(act>=2?'박제인간을 쓰러뜨린 보상이다':'혜철이를 쓰러뜨린 보상이다')+' · 골드 +'+bonus, finishNode); }
    else if(t==='boss') offerRelics(3,'👑 보스 보상','막 보스를 쓰러뜨린 보상이다 · 좋은 유물 확률 증가', finishNode, {weights:BOSS_RELIC_WEIGHTS});
    else if(combatRewardMul>1){ const bonus=Math.round(irand(36,65)*combatRewardMul); addGold(bonus,'roomReward'); combatRewardMul=1; offerRelics(3,'🎁 합방 보상','보상이 2배로! 골드 +'+bonus, finishNode); }
...
const LEGACY_EVENTS=[
  ...
  {tag:'📢 협찬 제안',title:'광고 읽어주기',body:'"이 영양제 한 번만 읽어주세요!" 골드는 두둑하지만 시청자가 빠져나가 다음 전투가 거세진다.',
   choices:[
     {t:'읽는다 — 골드 +80 / 다음 전투 적 강화',f:()=>{addGold(80,'event');updateHUD();nextCombatMods={cntMul:1.4,spdMul:1.12,banner:{big:'시청자 이탈',small:'적이 더 몰려온다'}};banner('협찬 골드 +80','',1300);finishNode();}},
     {t:'거절한다',f:()=>finishNode()},
   ]},
  ...
  {tag:'💎 큰손 등장',title:'VIP 도네러',body:'"리액션 크게 보여줘!" 골드를 듬뿍 주지만, 다음 전투 내내 발사속도가 느려지는 핸디캡이 붙는다.',
   choices:[
     {t:'받는다 — 골드 +120 / 다음 전투 발사속도 -20%',f:()=>{addGold(120,'event');updateHUD();nextCombatMods={fireHandicap:1.25,banner:{big:'리액션 타임',small:'발사속도 -20%'}};banner('VIP 골드 +120','',1300);finishNode();}},
...
const EVENTS=[
  ...
  {tag:'🕯 영혼 거래',title:'수상한 영혼',body:'투명한 손이 심장과 칼날을 저울에 올린다. 계약은 런이 끝날 때까지 남는다.',
   choices:[
     {t:'최대 체력 15% 감소 → 공격력 +15%',f:()=>{eventMaxHpMul(0.85);player.dmgAdd+=0.15;banner('영혼 거래','공격력 +15%',1500);updateHUD();finishNode();}},
     {t:'최대 체력 15% 증가 → 공격력 -10%',f:()=>{eventMaxHpDelta(Math.round(player.maxhp*0.15));player.dmgAdd-=0.10;banner('영혼 거래','최대 체력 +15%, 공격력 -10%',1500);updateHUD();finishNode();}},
     {t:'거절',f:()=>finishNode()},
   ]},
  ...
  {tag:'🧪 수상한 물약',title:'라벨 없는 병',body:'색이 계속 바뀌는 물약이다. 마시면 즉시 효과가 오지만, 무슨 효과인지는 모른다.',
   choices:[
     {t:'마신다',f:()=>{const result=pick(['heal','atk','armor','curse']);if(result==='heal'){healPlayer(Math.max(45,player.maxhp*0.45),player.x,player.y);banner('물약 효과','체력 회복',1400);finishNode();}else if(result==='atk'){player.dmgAdd+=0.12;banner('물약 효과','공격력 +12%',1400);updateHUD();finishNode();}else if(result==='armor'){player.armor=Math.min(0.85,player.armor+0.10);banner('물약 효과','받는 피해 -10%',1400);updateHUD();finishNode();}else{eventGiveRelic({curseOnly:true},finishNode);}}},
     {t:'버린다',f:()=>finishNode()},
   ]},
  {tag:'📚 금지된 서적',title:'봉인된 책',body:'책장을 넘기면 글자가 피부 위로 파고든다. 지식은 피를 요구한다.',
   choices:[
     {t:'읽기 → 체력 10% 소모 후 영구 강화',f:()=>{eventHpCostPct(0.10);const result=pick(['atk','crit','fire']);if(result==='atk'){player.dmgAdd+=0.10;banner('금서의 지식','공격력 +10%',1500);}else if(result==='crit'){player.critChance=Math.min(1,player.critChance+0.08);banner('금서의 지식','치명타 +8%',1500);}else{player.fireAdd+=0.12;banner('금서의 지식','발사속도 +12%',1500);}updateHUD();finishNode();}},
     {t:'무시',f:()=>finishNode()},
   ]},
...
const POTIONS=[
  ...
  {id:'combat', rarity:'common', name:'전투 물약', icon:'🟥', desc:'8초간 공격력 +25%', use:p=>{addPotionBuff(p,{id:'combat',name:'전투 물약',label:'공격력 +25%',icon:'🟥',desc:'8초간 공격력 증가',t:8,atkMul:0.25});}},
  ...
  {id:'fury', rarity:'rare', name:'분노 물약', icon:'🔥', desc:'8초간 공격력 +30%', use:p=>{addPotionBuff(p,{id:'fury',name:'분노 물약',label:'공격력 +30%',icon:'🔥',desc:'8초간 공격력 증가',t:8,atkMul:0.30});}},
  ...
  {id:'berserk_potion', rarity:'epic', name:'광폭 물약', icon:'💢', desc:'6초간 공격력 +50%', use:p=>{addPotionBuff(p,{id:'berserk_potion',name:'광폭 물약',label:'공격력 +50%',icon:'💢',desc:'6초간 공격력 증가',t:6,atkMul:0.50});}},
  ...
  {id:'awakening', rarity:'legend', name:'각성 물약', icon:'🌟', desc:'8초간 공격력 +25%, 발사속도 +25%', use:p=>{addPotionBuff(p,{id:'awakening',name:'각성 물약',label:'각성 +25%',icon:'🌟',desc:'8초간 공격력과 발사속도 증가',t:8,atkMul:0.25,fireAdd:0.25});}},
];
...
const LEVEL_PERKS=[
  ...
  {g:'rare',icon:'🛡️',name:'방어 특화',desc:'받는 피해 -3%',apply:p=>{p.armor+=0.03;}},
  ...
  // ===== 희귀 Rare =====
  {g:'rare',icon:'🎯',name:'정밀 조준',desc:'치명타 확률 +5%',apply:p=>{p.critChance+=0.05;}},
  ...
  {g:'rare',icon:'🗡️',name:'거인 사냥',desc:'보스 피해 +10%',apply:p=>{p.bossDmgMul+=0.10;}},
  ...
  {g:'epic',icon:'🔙',name:'쌍방향 사격',desc:'뒤로도 한 발 발사 + 공격력 +2',skip:p=>p.backShot,apply:p=>{p.backShot=true;p.dmg+=2;}},
  ...
  {g:'epic',icon:'🆘',name:'저체력 폭주',desc:'체력 30% 이하일 때 공격력 +40%',skip:p=>p.lowHpMul>0,apply:p=>{p.lowHpMul+=0.4;}},
  {g:'epic',icon:'🌪️',name:'처단',desc:'베인Q 시 주변 충격파 발생',skip:p=>p.dodgeBlast>0,apply:p=>{p.dodgeBlast+=18;}},
  {g:'epic',icon:'😤',name:'분노',desc:'주변 적 1마리당 공격력 +3%, 최대 10마리. 찍을 때마다 +3%씩 누적.',apply:p=>{p.crowdRage+=0.03;}},
  ...
  {id:'sharp_senses',g:'rare',icon:'🎯',name:'예리한 감각',desc:'치명타 확률 +5%',minLevel:3,maxLevel:15,build:'crit',tags:['combat','crit','seed'],apply:p=>{p.critChance+=0.05;}},
  {id:'weakpoint_strike',g:'epic',icon:'💥',name:'급소 타격',desc:'치명타 피해 +25%',minLevel:8,maxLevel:15,build:'crit',tags:['combat','crit'],apply:p=>{p.critMult+=0.25;}},
  {id:'red_pulse',g:'epic',icon:'🩸',name:'붉은 맥박',desc:'치명타 적중 시 3초 동안 재생 +5 (내부쿨 6초)',minLevel:8,maxLevel:14,build:'crit',tags:['combat','crit','sustain','keystone'],isMiniKeystone:true,skip:p=>p.redPulseRegen>0,apply:p=>{p.redPulseRegen=Math.max(p.redPulseRegen||0,5);}},
  {id:'gamblers_blade',g:'legend',icon:'🎲',name:'도박사의 칼날',desc:'치명타 확률 +15%, 치명타 피해 +50%, 비치명타 피해 -20%',minLevel:16,maxLevel:25,build:'crit',tags:['combat','crit','keystone'],isKeystone:true,skip:p=>p.gamblersBlade,apply:p=>{p.gamblersBlade=true;p.critChance+=0.15;p.critMult+=0.5;p.nonCritDmgMul-=0.20;}},
  ...
  {id:'corrosive_spread',g:'legend',icon:'🟢',name:'부식 확산',desc:'상태이상 적 처치 시 주변 적에게 독/화상 전이 강화. 직접 타격 피해 -8%',minLevel:16,maxLevel:25,build:'status',tags:['combat','status','keystone'],isKeystone:true,skip:p=>p.corrosiveSpread,apply:p=>{p.corrosiveSpread=true;p.statusDmgMul+=0.15;p.dmgMul-=0.08;}},
  ...
  {id:'shadow_barrage',g:'legend',icon:'🌑',name:'그림자 탄막',desc:'Q 후 1초 동안 투사체 +2. 베인Q 쿨다운 +25%',minLevel:16,maxLevel:25,build:'mobility',tags:['combat','mobility','projectile','keystone'],isKeystone:true,skip:p=>p.shadowBarrage,apply:p=>{p.shadowBarrage=true;p.shadowBarrageExtraShots=2;p.dodgeCdMul+=0.25;}},
  ...
  {id:'greed_contract',g:'legend',icon:'💎',name:'탐욕의 계약',desc:'골드 획득 +40%, 받는 피해 +10%',minLevel:16,maxLevel:25,build:'economy',tags:['economy','risk','keystone'],isKeystone:true,skip:p=>p.greedContract,apply:p=>{p.greedContract=true;p.goldMul+=0.4;p.damageTakenMul+=0.10;}},
  // ===== 신화 Myth =====
...
const PERK_META_BY_NAME={
  ...
  '쌍방향 사격':{minLevel:16,maxLevel:25,tags:['combat','projectile','keystone'],build:'projectile',isKeystone:true},
  ...
  '유도의 눈':{minLevel:16,maxLevel:25,tags:['combat','projectile','keystone'],build:'projectile',isKeystone:true},
...
const PERK_COUNTS={}; LEVEL_PERKS.forEach(p=>{ if(!p.removed) PERK_COUNTS[p.g]=(PERK_COUNTS[p.g]||0)+1; });
...
const SMALL_REWARDS=[
  ...
  {icon:'💥',name:'탄 개조',desc:'투사체 크기 +3%',apply:()=>{player.bulletSize+=0.03;banner('투사체 크기 +3%','',1000);}},
...
function shopCard(it,items,idx){
  ...
  const trainingLocked=it.kind==='training' && !!items.trainingBought && !it.maxed;
  const sold=it.kind==='training'?it.maxed:(it.bought||relicOwned);
  ...
  el.innerHTML=
    ...
    (sold||trainingLocked||pending?'<span class="shop-sold">'+(pending?'개봉 중':(trainingLocked?'이번 상점 훈련 완료':(it.soldLabel||'품절')))+'</span>':'')+
  ...
  el.onclick=async ()=>{
    ...
    const trainingLockedNow=it.kind==='training' && !!items.trainingBought && !it.maxed;
    const soldNow=it.kind==='training'?it.maxed:(it.bought||relicOwnedNow);
    const purchaseCost=Math.max(0,Math.round(Number(it.cost)||0));
    if(soldNow) return;
    if(it.pending) return;
    if(trainingLockedNow){ banner('훈련 완료','상점당 한 번만 훈련할 수 있다',900); return; }
...
function drawPlayer(){
  ...
  if(p.dodging>0){
    ...
    ctx.lineWidth=4;
    ctx.beginPath();
    ctx.arc(0,0,p.r+12+pulse*4,0,TAU);
    ctx.stroke();
    ctx.globalAlpha=0.62;
    ctx.strokeStyle='#38e8ff';
    ctx.lineWidth=2;
    ctx.beginPath();
    ctx.arc(0,0,p.r+21+pulse*7,0,TAU);
    ctx.stroke();
    ctx.restore();
  }
...
function spEffects(p){
  ...
  add(p.poison>0,'🟢','독침 +'+Math.round(p.poison),'독침','명중 시 4초간 독 부여. 최대 6스택. 찍을 때마다 스택당 독 피해 +3','poison');
  add(p.statusDotDmgMul>0,'🔥','상태이상 피해 +'+pc(p.statusDotDmgMul),'점화','화상/독 피해 증가','status-dot-damage');
  ...
  add(p.goldPower>0,'💸','골드 공격 보너스','골드 공격 보너스','보유 골드 100당 공격력 증가. 최대 +30%','gold-power');
...
function renderInventory(){
  ...
  const stats=[
    ...
    [armorDisplayLabel(armor), armorDisplayValue(armor)],
  ];
  // 투자한 항목만 추가 표시
  ...
  if(p.statusDotDmgMul>0) stats.push(['상태이상 피해', '+'+Math.round(p.statusDotDmgMul*100)+'%']);
...
function databaseRows(){
  ...
  if(tab==='perks'){
    return LEVEL_PERKS.filter(pk=>!pk.removed&&!TREE_ONLY_PERK_IDS.has(perkId(pk))).slice().sort(dbPerkSort).map(pk=>{
...
function devUnlockDatabase(){
  ...
  LEVEL_PERKS.filter(pk=>!pk.removed).forEach(pk=>dbDiscovered.perks.push(perkId(pk)));
  saveDbDiscovered();
  renderDatabase();
  return dbDiscovered;
}
...
window.debugTrainingQA=function(){
  ...
  return {
    ...
    attack:{base:Number(p.dmg)||0,mult:currentAttackMul(p),final:(Number(p.dmg)||0)*currentAttackMul(p),trainingBonus:Number(p.trainingAtkBonus)||0},
...
const TREE_NODES = [
  ...
  { id:'s_stable_barrage', name:'안정된 탄막', icon:'🎯', branch:'shot', req:['s_spread'], cost:2,
    desc:'투사체 피해 +8%, 투사체 속도 -8%', apply:p=>{ p.dmgMul+=0.08; p.bulletSpeedMul-=0.08; } },
  { id:'s_overcharge_round', name:'과충전 탄환', icon:'💥', branch:'shot', req:['weakpoint_strike'], cost:2,
    desc:'보스 피해 +18%, 일반 피해 -5%', apply:p=>{ p.bossDmgMul+=0.18; p.dmgAdd-=0.05; } },
  ...
  { id:'t_venom_mature', name:'맹독 숙성', icon:'🟢', branch:'status', req:['t_poison2'], cost:2,
    desc:'독 피해 +30%, 직접 피해 -5%', apply:p=>{ p.poison+=1.2; p.dmgMul-=0.05; } },
  ...
  { id:'corrosive_spread', name:'부식 확산', icon:'🟢', branch:'status', req:['elemental_overload','t_spread'], cost:3, isKeystone:true,
    ...
    apply:p=>{ p.corrosiveSpread=true; p.statusDmgMul+=0.15; p.dmgMul-=0.08; } },
  ...
  { id:'g_jackpot',name:'대박 도네',   icon:'🎰', branch:'gold', req:['g_magnet'], cost:3,
    ...
    apply:p=>{ p.donateChance+=0.08; p._levelHeal=(p._levelHeal||0)+8; } },
  ...
  { id:'m_risky_roll', name:'위험한 구르기', icon:'🌀', branch:'speed', req:['m_dodge'], cost:2,
    desc:'베인Q 쿨다운 -15%, 최대 체력 -6%', apply:p=>{ p.dodgeCdMul-=0.15; p.maxhp=Math.max(1,Math.round(p.maxhp*0.94)); p.hp=Math.min(p.hp,p.maxhp); } },
  { id:'m_dash_shot', name:'질주 사격', icon:'🔫', branch:'speed', req:['m_fire2'], cost:2,
    desc:'발사 속도 +12%, 받는 피해 +4%', apply:p=>{ p.fireAdd+=0.12; p.damageTakenMul+=0.04; } },
...
function migrateTreeOnlyPerksToTree(){
  ...
  player.perkIds=player.perkIds.filter(id=>{
    if(!perkByStoredId(id)) return false;
